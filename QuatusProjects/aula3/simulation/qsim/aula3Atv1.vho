...
ARCHITECTURE structure OF aula3Atv1 IS
...
SIGNAL \DEC1|ALT_INV_saida[1]~0_combout\ : std_logic;
...
\DEC1|ALT_INV_saida[1]~0_combout\ <= NOT \DEC1|saida[1]~0_combout\;
...
-- Equation(s):
-- \DEC1|saida[1]~0_combout\ = ( !\PC|DOUT\(1) & ( (!\PC|DOUT[2]~DUPLICATE_q\ & !\PC|DOUT\(0)) ) )
...
-- Equation(s):
-- \ROM1|memROM~0_combout\ = ( \PC|DOUT\(1) & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) # ( !\PC|DOUT\(1) & ( (!\PC|DOUT\(0)) # (!\PC|DOUT[2]~DUPLICATE_q\) ) )
...
-- Equation(s):
-- \DEC1|saida[2]~1_combout\ = ( !\PC|DOUT[2]~DUPLICATE_q\ & ( \PC|DOUT\(1) ) ) # ( \PC|DOUT[2]~DUPLICATE_q\ & ( !\PC|DOUT\(1) & ( !\PC|DOUT\(0) ) ) ) # ( !\PC|DOUT[2]~DUPLICATE_q\ & ( !\PC|DOUT\(1) & ( \PC|DOUT\(0) ) ) )
...
PORT MAP (
	...
	asdata => \SW[0]~input_o\,
	clrn => \DEC1|ALT_INV_saida[1]~0_combout\,
	sload => \ROM1|ALT_INV_memROM~0_combout\,
	ena => \DEC1|saida[2]~1_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
