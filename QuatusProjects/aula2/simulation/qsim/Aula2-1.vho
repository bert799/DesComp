...
ARCHITECTURE structure OF Aula2_1 IS
...
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[4]~input_o\,
	datab => \ALT_INV_Endereco[5]~input_o\,
	datac => \ALT_INV_Endereco[6]~input_o\,
	datad => \ALT_INV_Endereco[7]~input_o\,
	datae => \ALT_INV_Endereco[8]~input_o\,
	dataf => \ALT_INV_Endereco[9]~input_o\,
	combout => \memROM~0_combout\);

\memROM~7\ : cyclonev_lcell_comb
-- Equation(s):
-- \memROM~7_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[2]~input_o\ & (!\Endereco[1]~input_o\ & \Endereco[0]~input_o\)) # (\Endereco[2]~input_o\ & (!\Endereco[1]~input_o\ $ (\Endereco[0]~input_o\))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001000001000001000000000000000000010000010000010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
...
-- Equation(s):
-- \memROM~6_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[2]~input_o\ & ((!\Endereco[0]~input_o\) # (\Endereco[1]~input_o\))) # (\Endereco[2]~input_o\ & ((\Endereco[0]~input_o\))))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000100010000010101000000000000000001000100000101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
...
-- Equation(s):
-- \memROM~5_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[2]~input_o\ & ((\Endereco[0]~input_o\))) # (\Endereco[2]~input_o\ & (\Endereco[1]~input_o\)))) ) )
...
-- Equation(s):
-- \memROM~1_combout\ = (\Endereco[0]~input_o\ & (\Endereco[1]~input_o\ & (!\Endereco[3]~input_o\ & \memROM~0_combout\)))
...
-- Equation(s):
-- \memROM~4_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & ((!\Endereco[2]~input_o\ & (\Endereco[1]~input_o\ & !\Endereco[0]~input_o\)) # (\Endereco[2]~input_o\ & (!\Endereco[1]~input_o\ & \Endereco[0]~input_o\)))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000000010000010000000000000000000000000100000100000",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
...
-- Equation(s):
-- \memROM~3_combout\ = ( \memROM~0_combout\ & ( (!\Endereco[3]~input_o\ & (((\Endereco[0]~input_o\) # (\Endereco[1]~input_o\)) # (\Endereco[2]~input_o\))) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "0000000000000000001010101010101000000000000000000010101010101010",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	dataa => \ALT_INV_Endereco[3]~input_o\,
