...
ARCHITECTURE structure OF Aula2Atividade2 IS
...
-- Equation(s):
-- \PC|DOUT[2]~1_combout\ = ( \PC|DOUT\(0) & ( !\PC|DOUT[1]~DUPLICATE_q\ $ (!\PC|DOUT\(2)) ) ) # ( !\PC|DOUT\(0) & ( \PC|DOUT\(2) ) )
...
-- Equation(s):
-- \ROM1|memROM~1_combout\ = ( !\PC|DOUT[0]~DUPLICATE_q\ & ( !\PC|DOUT[1]~DUPLICATE_q\ & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) )
...
-- Equation(s):
-- \ROM1|memROM~2_combout\ = ( !\PC|DOUT\(1) & ( \PC|DOUT[2]~DUPLICATE_q\ & ( !\PC|DOUT\(0) ) ) ) # ( \PC|DOUT\(1) & ( !\PC|DOUT[2]~DUPLICATE_q\ ) ) # ( !\PC|DOUT\(1) & ( !\PC|DOUT[2]~DUPLICATE_q\ & ( \PC|DOUT\(0) ) ) )
...
PORT MAP (
	...
	clrn => \ROM1|ALT_INV_memROM~1_combout\,
	ena => \ROM1|memROM~2_combout\,
	devclrn => ww_devclrn,
	devpor => ww_devpor,
	q => \REGA|DOUT\(0));
...
-- Equation(s):
-- \ULA1|Add0~5_sumout\ = SUM(( \REGA|DOUT\(1) ) + ( !\SW[7]~input_o\ $ (((!\PC|DOUT\(2) & ((\PC|DOUT[0]~DUPLICATE_q\) # (\PC|DOUT[1]~DUPLICATE_q\))))) ) + ( \ULA1|Add0~2\ ))
-- \ULA1|Add0~6\ = CARRY(( \REGA|DOUT\(1) ) + ( !\SW[7]~input_o\ $ (((!\PC|DOUT\(2) & ((\PC|DOUT[0]~DUPLICATE_q\) # (\PC|DOUT[1]~DUPLICATE_q\))))) ) + ( \ULA1|Add0~2\ ))
...
-- Equation(s):
-- \ULA1|Add0~9_sumout\ = SUM(( \REGA|DOUT\(2) ) + ( !\SW[8]~input_o\ $ (((!\PC|DOUT\(2) & ((\PC|DOUT\(0)) # (\PC|DOUT[1]~DUPLICATE_q\))))) ) + ( \ULA1|Add0~6\ ))
-- \ULA1|Add0~10\ = CARRY(( \REGA|DOUT\(2) ) + ( !\SW[8]~input_o\ $ (((!\PC|DOUT\(2) & ((\PC|DOUT\(0)) # (\PC|DOUT[1]~DUPLICATE_q\))))) ) + ( \ULA1|Add0~6\ ))
...
-- Equation(s):
-- \ROM1|memROM~0_combout\ = ( \PC|DOUT[2]~DUPLICATE_q\ ) # ( !\PC|DOUT[2]~DUPLICATE_q\ & ( (!\PC|DOUT\(0) & !\PC|DOUT\(1)) ) )

-- pragma translate_off
GENERIC MAP (
	extended_lut => "off",
	lut_mask => "1100110000000000110011000000000011111111111111111111111111111111",
	shared_arith => "off")
-- pragma translate_on
PORT MAP (
	datab => \PC|ALT_INV_DOUT\(0),
